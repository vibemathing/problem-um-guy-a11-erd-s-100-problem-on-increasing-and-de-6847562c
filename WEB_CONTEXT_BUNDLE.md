...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GUY-A11"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-v1",
      "problem_contract_sha256": "cb41b33d6d14a672777f5e6b2d0a571de3116c1c9d285ef332292ffcc2efa725",
      "problem_id": "problem:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c",
      "route_id": "route:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-source-fidelity-01",
      "graph_id": "graph:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist an $n_0$ such that for every $i$ and $n > n_0$ we have $d_{n+2i} > d_{n+2i+1}$ and $d_{n+2i+1} < d_{n+2i+2}$, where $d_n = p_{n+1} - p_n$?"
          },
          "statement_sha256": "a3e74f09041d7a9b8df38a9af9f8312ddcb3ac4db4575b7bd35f68aefc31c9b4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-root",
      "route_id": "route:um-guy-a11-erd-s-100-problem-on-increasing-and-de-6847562c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-guy-a11-26fa246ce411",
        "url": "https://www.unsolvedmath.com/problems/GUY-A11"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
